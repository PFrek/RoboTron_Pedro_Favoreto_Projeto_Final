...
CT-C02: POST Cadastrar Carrinho Como Administrador 201
    ...
    # Validar que o carrinho foi realmente criado
...
CT-C03: POST Cadastrar Carrinho Como Usuario Padrao 201
...
CT-C04: POST Tentar Cadastrar Carrinho Com Produto Duplicado 400
...
CT-C05: POST Tentar Cadastrar Mais De Um Carrinho Com Um Usuario 400
...
CT-C06: POST Tentar Cadastrar Um Carrinho Com Produto Inexistente
...
CT-C07: POST Tentar Cadastrar Carrinho Sem Quantidade De Produto Suficiente 400
...
CT-C08: POST Tentar Cadastrar Carrinho Com IdProduto Em Branco 400
...
CT-C09: POST Tentar Cadastrar Carrinho Sem IdProduto 400
...
CT-C10: POST Tentar Cadastrar Carrinho Com Quantidade Em Branco 400
...
CT-C11: POST Tentar Cadastrar Carrinho Sem Quantidade 400
...
CT-C12: POST Tentar Cadastrar Carrinho Sem Login 401
...
CT-C13: GET Buscar Carrinho Existente 200
...
CT-C14: GET Buscar Carrinho Inexistente 400
...
CT-C15: DELETE Concluir Compra Com Carrinho Existente 200
    [Documentation]       Teste de concluir compra com carrinho existente.
    [Tags]                DELETE
    #####
    # Setup
    Criar Sessao
    ...
    # Verificar se foi mesmo excluído
    ${response}=           Enviar GET    /carrinhos/${id_carrinho}
    Validar Status Code    400    ${response}
    Validar Mensagem       Carrinho não encontrado    ${response}
...
CT-C16: DELETE Cancelar Compra Com Carrinho Existente 200
    [Documentation]       Teste de cancelar compra com carrinho existente.
    [Tags]                DELETE
    #####
    # Setup
    Criar Sessao
